        ...
        <>
          <div className="space-y-4">
            {cartItems.map((product: Product) => (
              <div
                key={product.id}
                className="flex items-center justify-between p-4 rounded shadow-md bg-gray-100"
              >
                <img
                  src={product.image}
                  alt={product.title}
                ...
                <div className="flex-1">
                  <h2
                    className="text-lg font-semibold hover:text-sky-600 transition-colors duration-200 cursor-pointer"
